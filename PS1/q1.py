...
brand_dummies = [col for col in data.columns if col[:6] == 'brand_' and len(col) < 9 and col != 'brand_1']

X2 = data[['price_per_50', 'prom_', *brand_dummies]]
...
store_brand = [col for col in data.columns if col[:6] == 'brand_' and len(col) > 9 and col != 'brand_5_store_2']


X3 = data[['price_per_50', 'prom_', *store_brand]]
...
data['elasticity_est_1'] = results1.params['price_per_50']*data['price_per_50']*(1-data['ms_by_store_week'])
data['elasticity_est_2'] = results2.params['price_per_50']*data['price_per_50']*(1-data['ms_by_store_week'])
data['elasticity_est_3'] = results3.params['price_per_50']*data['price_per_50']*(1-data['ms_by_store_week'])
